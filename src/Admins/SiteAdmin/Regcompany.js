...
import Regcompanycard from "../SiteAdmin/components/Regcompanycard";
...
<div className="d-flex d.column flex-wrap">
 {/* <Regcompanycard/> <Regcompanycard/><Regcompanycard/> */}
 {approve_company.map((item,i)=><Regcompanycard key={i} data={item}/>)}
